...
public class GoParams {
	enum SearchType{
		/** plan time out*/
		plan,
		/** chess.search only fixed depth*/
		fixedDepth,
		/** fixed chess.search time*/
		fixedTime,
		/** chess.search infinitely (until told to stop explicitly)*/
		infinite,
	}
	...
	public GoParams(String goCommand) {
		...
		//note, this will not be correct if the different chess.search types are not
