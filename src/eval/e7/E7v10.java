...
/** slight change in how attack mask is calculated, very slight improvement*/
public final class E7v10 implements Evaluator2{
	...
	@Override
	public void processMove(final long encoding) {
		update(encoding, 1);
	}
	...
	private static int scoreMobility(final int player, final State4 s,
		...
		final long pawnAttackMask = Masks.getRawPawnAttacks(player, s.pawns[player]);
