...
public class SFParams {
	...
	public static EvalParameters buildEval(){
		...
		//these might be off from actual SF values
		...
		final Weight[][] passedPawnRowWeight = new Weight[2][8];
		passedPawnRowWeight[0][0] = W(-999,-999);
		for(int r = 1; r < 8; r++){
			final int rr = r*(r-1);
			passedPawnRowWeight[0][r] = W(20*rr, 10*(rr+r+1)); 
		}
		...
		p.doubledPawns = new Weight[][]{
			{W(-13,-43), W(-20,-48), W(-23,-48), W(-23,-48), W(-23,-48), W(-23,-48), W(-20,-48), W(-13,-43)},
			{W(-13,-43), W(-20,-48), W(-23,-48), W(-23,-48), W(-23,-48), W(-23,-48), W(-20,-48), W(-13,-43)},
		};
		...
		p.pawnChain = new Weight[]{
				W(11,-1), W(13,-1), W(13,-1), W(14,-1), W(14,-1), W(13,-1), W(13,-1), W(11,-1)
		};
