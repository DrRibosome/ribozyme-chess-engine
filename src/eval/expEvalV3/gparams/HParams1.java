...
public class HParams1 {
	...
	public static EvalParameters buildEval(){
		...
		p.materialWeights[State4.PIECE_TYPE_QUEEN] = 870;
		p.materialWeights[State4.PIECE_TYPE_ROOK] = 456;
		p.materialWeights[State4.PIECE_TYPE_BISHOP] = 303;
		p.materialWeights[State4.PIECE_TYPE_KNIGHT] = 295;
		...
		final Weight[][] isolatedPawns = new Weight[][]{
				{W(-37/2, -45/2), W(-54/2, -52/2), W(-60/2, -52/2), W(-60/2, -52/2), W(-60/2, -52/2), W(-60/2, -52/2), W(-54/2, -52/2), W(-37/2, -45/2)},
				{W(-25/2, -30/2), W(-36/2, -35/2), W(-40/2, -35/2), W(-40/2, -35/2), W(-40/2, -35/2), W(-40/2, -35/2), W(-36/2, -35/2), W(-25/2, -30/2)},
		};
		...
		p.pawnChain = new Weight[]{
				W(5,0), W(6,0), W(8,0), W(10,0), W(10,0), W(8,0), W(6,0), W(5,0)
		};
