package eval.legacy.evalV8;

import static eval.legacy.evalV8.Eval8Weights.BONUS_BISHOP_PAIR;
import static eval.legacy.evalV8.Eval8Weights.BONUS_MATERIAL_ADVANTAGE;
import static eval.legacy.evalV8.Eval8Weights.BONUS_ROOK_HALF_OPEN_FILE;
import static eval.legacy.evalV8.Eval8Weights.BONUS_ROOK_ON_7TH;
import static eval.legacy.evalV8.Eval8Weights.BONUS_ROOK_OPEN_FILE;
import static eval.legacy.evalV8.Eval8Weights.BONUS_TEMPO;
import static eval.legacy.evalV8.Eval8Weights.DANGER_KING_ATTACKS;
import static eval.legacy.evalV8.Eval8Weights.DANGER_PAWN_SHIELD_GAP;
import static eval.legacy.evalV8.Eval8Weights.GRAIN_SIZE;
import static eval.legacy.evalV8.Eval8Weights.MOBILITY_BONUSES;
import static eval.legacy.evalV8.Eval8Weights.PENALTY_DOUBLED_PAWNS;
import static eval.legacy.evalV8.Eval8Weights.PENALTY_ISOLATED_PAWN;
import static eval.legacy.evalV8.Eval8Weights.PENALTY_TRIPLED_PAWNS;
import static eval.legacy.evalV8.Eval8Weights.kingDangerSquares;
import static eval.legacy.evalV8.Eval8Weights.kingDangerValues;
import static eval.legacy.evalV8.Eval8Weights.pieceSquareTables;
import static eval.legacy.evalV8.Eval8Weights.pieceValues;
