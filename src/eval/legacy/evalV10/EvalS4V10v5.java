...
import static eval.legacy.evalV10.Eval10Weights2.BONUS_BISHOP_PAIR;
import static eval.legacy.evalV10.Eval10Weights2.BONUS_MATERIAL_ADVANTAGE;
import static eval.legacy.evalV10.Eval10Weights2.BONUS_ROOK_HALF_OPEN_FILE;
import static eval.legacy.evalV10.Eval10Weights2.BONUS_ROOK_ON_7TH;
import static eval.legacy.evalV10.Eval10Weights2.BONUS_ROOK_OPEN_FILE;
import static eval.legacy.evalV10.Eval10Weights2.BONUS_TEMPO;
import static eval.legacy.evalV10.Eval10Weights2.DANGER_KING_ATTACKS;
import static eval.legacy.evalV10.Eval10Weights2.DANGER_PAWN_SHIELD_GAP;
import static eval.legacy.evalV10.Eval10Weights2.DANGER_STORMING_PAWN;
import static eval.legacy.evalV10.Eval10Weights2.MOBILITY_BONUSES;
import static eval.legacy.evalV10.Eval10Weights2.PENALTY_DOUBLED_PAWNS;
import static eval.legacy.evalV10.Eval10Weights2.PENALTY_ISOLATED_PAWN;
import static eval.legacy.evalV10.Eval10Weights2.PENALTY_TRIPLED_PAWNS;
import static eval.legacy.evalV10.Eval10Weights2.kingDangerSquares;
import static eval.legacy.evalV10.Eval10Weights2.kingDangerValues;
import static eval.legacy.evalV10.Eval10Weights2.pieceSquareTables;
import static eval.legacy.evalV10.Eval10Weights2.pieceValues;
