...
public final class MobilityEval {
	...
	static{
		...
		interpolate(new int[]{-3,-3}, new double[]{-4,-4}, new double[]{20,25}, knightMobilityWeights);
		...
		interpolate(new int[]{-3,-3}, new double[]{-4,-7}, new double[]{30,30}, bishopMobilityWeights);
		...
		interpolate(new int[]{-3,-3}, new double[]{-4,-7}, new double[]{15,50}, rookMobilityWeights);
		...
		interpolate(new int[]{-3,-1}, new double[]{-4,-7}, new double[]{20,40}, queenMobilityWeights);
