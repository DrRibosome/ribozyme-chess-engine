...
public final class MobilityEval {
	...
	static{
		...
		interpolate(new int[]{-2,-2}, new double[]{-2,-2}, new double[]{20,50}, knightMobilityWeights);
		...
		interpolate(new int[]{-3,-2}, new double[]{-4,-20}, new double[]{20,55}, queenMobilityWeights);
