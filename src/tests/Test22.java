...
public class Test22 {
	public static void main(String[] args){
		...
		final int maxPly = 6;
		SearchS4V22qzit.SearchStat agg = new SearchS4V22qzit.SearchStat();
		...
		for(char[][] c: boards){
			...
			SearchS4V22qzit search = new SearchS4V22qzit(8, s, e1, 20);
			
			SearchS4V22qzit.SearchStat stats = search.search(State4.WHITE, maxPly, new int[4]);
			agg(stats, agg);
			print(stats);
	...
	private static void agg(SearchS4V22qzit.SearchStat s, SearchS4V22qzit.SearchStat agg){
	...
	private static void print(SearchS4V22qzit.SearchStat s){
