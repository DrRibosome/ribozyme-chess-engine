...
public final class SearchS4V31Ext implements Search3{
	...
	private final static class MoveList{
		...
		/** resent move list to begin search anew*/
		public void reset(){
			prevMove = 0;
			ext = 0;
		}
	...
	public SearchS4V31Ext(State4 s, Evaluator2<State4> e, int hashSize, boolean record){
		this.s = s;
		this.e = e;
		m = new ZMap(hashSize);
